               ...
               <div class="input_block">
                ...
                <div class="input_block">
                    <div class="b13_title">發票開立</div>
                         <div>
                            <input id="invoice1" type="radio" name="invoice" value="1" checked="checked"><label for="invoice1"><span><span></span></span>二聯式</label>
                          </div>
                          <div>
                            <input id="invoice2" type="radio" name="invoice" value="2"><label for="invoice2"><span><span></span></span>三聯式</label>
                          </div>
                </div>
                <div class="input_block">
                 ...
                 <div class="input_block">
                    <input id="Uniform" class="b10_input" type="text" placeholder="公司統編" autocomplete="off">
                    <div class="b13_remark">﹙僅付費課程需填寫﹚</div>
                </div>
                <div class="input_block">
                     <div>
                        ...
                        <span class="b13_remark">﹙全天付費課程有附中午餐點，一般半天課程或研討會則無需填寫﹚</span>
                         ...
                         <div>
                            <input id="lunch_box1" type="radio" name="lunch_box" value="1" checked="checked"><label for="lunch_box1"><span><span></span></span>一般</label>
                          </div>
                          <div>
                            <input id="lunch_box2" type="radio" name="lunch_box" value="2"><label for="lunch_box2"><span><span></span></span>素食</label>
                          </div>
                </div>
                <div class="input_block">
                     <div>
                    ...
                    <div>
                            <input id="agree1" type="radio" name="agree" value="1" checked="checked"><label for="agree1"><span><span></span></span>同意</label>
                          </div>
                          <div>
                            <input id="agree2" type="radio" name="agree" value="2"><label for="agree2"><span><span></span></span>不同意</label>
                          </div>
                </div>
                <div class="input_block">
                     <div>
