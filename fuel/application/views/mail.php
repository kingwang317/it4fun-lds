...
<div style='margin: 0px auto;text-align:left;width:600px;background-color:#f1f1f1;'>
    <div style='padding:30px 0 10px 0;'>
        <img src="<?php echo site_url()?>assets/templates/images/mail/logo.png">
    ...
    <div style='background-color:#fff;padding:20px 50px 20px 50px;'>
        ...
        <div style="line-height:26px;">
            <div style='font-size:14px;display:inline-block;width:42px;'>姓名：</div><div style='font-size:14px;display:inline-block;'>戴小姐</div>
        </div>
        <div style="line-height:26px;">
            <div style='font-size:14px;display:inline-block;width:70px;'>電子信箱：</div><div style='font-size:14px;display:inline-block;'>alex6028@yahoo.com.tw</div>
        </div>
        <div style="line-height:26px;">
            <div style='font-size:14px;display:inline-block;width:70px;'>連絡電話：</div><div style='font-size:14px;display:inline-block;'>0912345678</div>
        </div>
        <div style="line-height:26px;">
            <div style='font-size:14px;display:inline-block;width:70px;'>詢問主旨：</div><div style='font-size:14px;display:inline-block;'>ISO 22000食品安全管理系統</div>
        </div>
        <div style="line-height:26px;">
            <div style='font-size:14px;display:inline-block;width:70px;'>公司人數：</div><div style='font-size:14px;display:inline-block;'>1~30預計配合的驗證機構：我不知道驗證單位，請推薦</div>
        </div>
        <div style="line-height:26px;">
            <div style='font-size:14px;display:inline-block;width:70px;'>詢價內容：</div><div style='font-size:14px;display:inline-block;'>本公司為新設立之食品加工廠，專營肉品加工調理，欲申請ISO22000，請問貴公司輔導方案及費用，感謝。</div>
        </div>
    </div>
