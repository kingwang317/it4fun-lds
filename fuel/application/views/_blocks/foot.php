...
<div id="foot" class="foot">
    ...
    <div class="foot_block_all">
        ...
        <div class="foot_block">
            ...
            <div class="contact"><a href="#">品質管理</a></div>
            <div class="contact"><a href="#">食品安全</a></div>
            <div class="contact"><a href="#">驗廠與社會責任</a></div>
            <div class="contact"><a href="#">環境管理系列</a></div>
            <div class="contact"><a href="#">供應鏈安全</a></div>
            <div class="contact"><a href="#">資訊安全</a></div>
            <div class="contact"><a href="#">風險管理</a></div>
            <div class="contact"><a href="#">神秘客認證</a></div>
        </div>
        <div class="foot_block">
            <div class="title">最新消息</div>
            <div class="contact"><a href="#">輔導實績</a></div>
            <div class="contact"><a href="#">ISO條文改版</a></div>
            <div class="contact"><a href="#">免費課程</a></div>
            <div class="contact"><a href="#">ISO認證常見問答</a></div>
            <div class="contact"><a href="#">推薦閱讀</a></div>
            <div class="contact"><a href="#">產業新聞</a></div>
        </div>
        <div class="foot_block">
            <div class="title">ISO教育訓練</div>
            <div class="contact"><a href="#">免費課程</a></div>
            <div class="contact"><a href="#">收費課程</a></div>
