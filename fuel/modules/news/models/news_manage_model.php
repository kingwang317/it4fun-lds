...
class News_manage_model extends MY_Model {
	...
	{
		$sql = @"SELECT *,(SELECT code_name FROM mod_code WHERE mod_code.code_id = mod_news.type) AS type_name FROM mod_news $filter ORDER BY `type`,`news_order` DESC  LIMIT $dataStart, $dataLen";
